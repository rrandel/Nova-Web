              ...
              <div className="mt-6 text-gray-900 dark:text-white">
                <div className="mt-6 space-y-6 text-gray-900 dark:text-white prose dark:prose-invert">
                  <p className="text-lg text-gray-900 dark:text-white">
                    ...
                    <a href="https://www.youtube.com/watch?v=JxIZbV_XjAs&list=PLlrATfBNZ98dC-V-N3m0Go4deliWHPFwT" className="font-semibold text-orange-400"> Game Engine series on YouTube</a>
